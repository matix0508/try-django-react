...
export default function NavBar(props) {
    return (
        <div className="w-full flex flex-row items-center p-2 justify-between bg-indigo-50 shadow-xs bg-indigo-500">
        ...
        <input type="search" name="serch" placeholder="Search"
            ...
            <div className="flex items-center mr-8 hidden md:flex">
                <a href="https://github.com/Charlie85270/tail-kit"
                ...
                <span className="sr-only">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                         className="text-xl transition-colors duration-200" viewBox="0 0 1792 1792">
                        <path
                ...
                <a href="#" className="">
                    <svg width="2048" height="1792" fill="currentColor"
                         className="mr-2 w-8 h-8 text-white hover:text-gray-100" viewBox="0 0 2048 1792"
                         xmlns="http://www.w3.org/2000/svg">
                        <path
